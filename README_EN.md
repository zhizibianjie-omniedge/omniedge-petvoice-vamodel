...
```mermaid
graph TD
    A[Pet Vocalization Audio] --> B[Audio Transformer<br/>Feature Extractor]
    B --> C[Multi-Task Learning<br/>Framework]
    C --> D[VA Regression<br/>Prediction]
    C --> E[Auxiliary<br/>Tasks]
    D --> F[Continuous Emotion<br/>Space]
    E --> F
    F --> G[Refined Emotion<br/>Understanding]
```
