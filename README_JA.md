...
**OmniEdge**は深圳に拠点を置くAIコンサルティング会社で、ペットAI技術の研究開発と産業化に特化しています。創業者として、**黄俊耀**は中国アクチュアリー協会での専門的背景を活かし、リスクデータ分析の概念を革新的にペット感情認識分野に応用しています。
...
- **起業家経歴**: OmniEdge創業者、ペット分野でのAI応用に専念
